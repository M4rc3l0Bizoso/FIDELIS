...
export default function App() {
  ...
  const [currentPage, setCurrentPage] = useState<'home' | 'summarizer'>('home');
    ...
    <div className="min-h-screen bg-gradient-to-br from-secondary-50 to-primary-50">
      ...
      <header className="bg-white shadow-sm border-b border-secondary-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-secondary-900">SumUP</h1>
              <p className="text-xs text-secondary-600">Professional Document Summarizer</p>
            </div>
          </div>
      ...
      <footer className="border-t border-secondary-200 bg-white mt-12 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-secondary-600">
          <p>© 2024 SumUP. Built with precision for academic excellence.</p>
        </div>
      </footer>
    </div>
  );
